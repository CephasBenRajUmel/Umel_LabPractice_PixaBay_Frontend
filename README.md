...
# How To Run Locally
1. Create a config.js file following the contents of config.sample.js
2. Get your API key from Pixabay and replace Secret-Api-Key-Here with your own API key
3. Run the code.